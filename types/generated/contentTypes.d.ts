...
export interface ApiRequestServiceDetailRequestServiceDetail
  extends Struct.CollectionTypeSchema {
  collectionName: 'request_service_details';
  info: {
    displayName: 'RequestServiceDetail';
    pluralName: 'request-service-details';
    singularName: 'request-service-detail';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::request-service-detail.request-service-detail'
    > &
      Schema.Attribute.Private;
    priceFinal: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer;
    requestService: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fileImage: Schema.Attribute.Media<'images', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
...
export interface ApiUbigeoServiceUbigeoService
  extends Struct.CollectionTypeSchema {
  collectionName: 'ubigeo_services';
  info: {
    displayName: 'UbigeoService';
    pluralName: 'ubigeo-services';
    singularName: 'ubigeo-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.Relation<'oneToOne', 'api::service.service'>;
    ubigeo: Schema.Attribute.Relation<'oneToOne', 'api::ubigeo.ubigeo'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
